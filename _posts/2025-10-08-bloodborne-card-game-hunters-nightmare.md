...
![Bloodborne: The Card Game - The Hunter's Nightmare](https://i.imgur.com/Jm8ynpT.jpg)
...
- **Monsters and Bosses**: New faces to haunt your dreams and ruin your strategies.
- **Chalice Dungeon Tiles**: New locations that add more variety and tactical options.
- **Death Tokens**: Because dying once per round wasn't enough.
- **New Weapons and Items**: More tools to inflict pain on your enemies (and yourself).

**Fun Fact**: The artwork is so detailed that you might find yourself admiring a monster right before it devours you.

## Gameplay Enhancements

### New Mechanics

The Hunter's Nightmare introduces a few new mechanics that change how you approach the game. The Chalice Dungeon tiles create a more dynamic and unpredictable battlefield, while the death tokens add an extra layer of risk and reward. Now, every decision feels even more critical, which is great because we all needed more stress in our lives, right?
...
- **Increased Replayability**: The new elements add more variety, making each playthrough unique.
- **More Tactical Depth**: The Chalice Dungeon tiles and death tokens require more strategic thinking.
- **High-Quality Components**: The artwork and miniatures are top-notch, adding to the immersive experience.
- **Challenging Gameplay**: The new monsters and bosses offer a fresh challenge, even for veterans of the base game.

### Cons

- **Complex Setup**: The additional components and mechanics make setup more time-consuming.
- **Learning Curve**: New players might find the expanded rules overwhelming.
- **Punishing Difficulty**: The game was already tough, and the expansion makes it even harder. Not for the faint of heart.
