---
title: Exploding Kittens Exploding Minions Card Game Review
...
![](/assets/img/exploding-minions.jpg)
...
![Exploding Minions in action](/assets/img/exploding-minions-action.jpg)
...
If you want a deeper comparison, you can read our side by side with the original Exploding Kittens here: {% post_url 2020-05-22-exploding-kittens-review %}. For a broader look at how we rank family friendly party games, visit our guide post here: {% post_url 2020-08-14-family-coop-titles %}.
...
For those who prefer to shop online, we recommend verifying shipping windows and checking for any local retailer exclusive promos. And if you want to support the Geeknite site while you shop, you can head to our friendly hub of game night resources here: {% post_url 2022-02-11-geeknite-shopping-tips %}.
...
If you are curious about other lighter, kid friendly party games that pair well with Exploding Minions, we also cover a number of titles in our roundup here: {% post_url 2021-03-18-best-kid-friendly-party-games %} and our hall of fame post here: {% post_url 2020-12-02-geeknite-greats %}.
...
If you want to revisit or compare to other Geeknite favorites, check out our deep dive into the sparkle of party games here: {% post_url 2021-06-09-deep-dive-party-games %}. For a more nostalgic look at Exploding Kittens and friends, our retro review archive is a great place to wander: {% post_url 2019-11-07-exploding-kittens-throwback %}.
...
**Ready to join the chaos? Buy it through our trusted affiliate partner and support Geeknite while you expand your game night repertoire.**

**Buy now via our affiliate link: https://affiliate.example.com/exploding-minions**
