---
title: 'Phase 10 Card Game: Mattel Rummy with a Twist — New Open Box (2010)'
date: 2026-02-11
tags:
  - board-games
  - card-games
...
![Phase 10 Open Box](./assets/images/phase10-openbox-2010.jpg)
...
1. Shuffle the deck and deal a pre-defined number of cards to each player (the exact number varies by edition).
2. Place the remaining deck in the center as the draw pile and flip the top card to start the discard pile.
3. On your turn, draw one card and decide whether to complete your current phase, then discard one card.
4. If you complete the current phase, you advance to the next phase for subsequent rounds. The goal is to be the first to complete all ten phases across multiple rounds.
5. When a player goes out (has no cards left after discarding last card), the hand ends and you tally points. The player with the lowest score after a pre-decided number of rounds wins.
