...
![Factory sealed wrapper]({{ '/assets/img/mtg-fourth-edition-wrapper.jpg' | relative_url }})
...
For those who crave more context, you can wander to the evergreen MTG lore corner on the web (for example, the Fourth Edition entry on MTG Wiki) to see how the set fit into the ongoing tapestry of the game. [Fourth Edition on MTG Wiki](https://mtg.fandom.com/wiki/Fourth_Edition) quietly waits for you between print runs and forum debates. And if you want to compare with other retro boosters, check out this archive post on [nostalgia-driven MTG unboxings](https://example.com/nostalgia-mtg-unboxings) to see where Fourth Edition sits on the shelf of time.
