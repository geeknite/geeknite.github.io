---
title: Zombicide: Black Plague - Quest Book Review
date: 2026-03-18
tags:
  - board games
  - Zombicide
...
Zombicide: Black Plague fans know the vibe already: a swamp of dice, plastic corpses, and the occasional heroic twitch from a survivor who swore they were done with loot tables but then remembered the tavern had a particularly nice shield. When the Quest Book expansion dropped, it felt like the game finally looked at us and said, you know what would make this more ridiculous? A campaign mode that trades swords for storylines and chaos for character arcs. If the core game is a high-energy sprint through a zombie apocalypse, the Quest Book is the cinematic arc that asks, what if we told this sprint as a trilogy with cliffhangers and extra snacks?

This review dives into what the Quest Book actually brings to the table, whether it improves the game or simply makes your table groan under the weight of new cards, and whether you should drop extra cash on more plastic friends who all have questionable fashion sense. For context, this is not a replacement for the base game, nor a simple add on with a few more monsters. It is a structured campaign that invites you to commit to a story with a beginning, middle, and ending that might involve a tragic misunderstanding of the word hero. Strap in, grab your favorite axe-wielding nun or rogue wizard who somehow survived the initial chaos, and let’s dive into the mythic grind of questing in a plague-ridden medieval fantasy setting.

## What is the Quest Book, really?

The Quest Book is not just a stack of new missions; it is a narrative spine for Zombicide: Black Plague that stitches together a campaign arc across multiple sessions. You won’t merely push another wave of death engines; you’ll track a storyline with goals that unfold as you progress. The expansion adds a campaign deck, a handful of new character options, some fresh undead types, and a set of quest-specific rules that nudge you toward strategic planning rather than pure wipe-and-rinse chaos. If the base game is a chaotic survival brawl with friends, the Quest Book is the director’s cut where you learn to cooperate with a bit more patience while still screaming at the necessity of teamwork.

For those who love the crunchy bits, the Quest Book dos and don’ts include campaign milestones, quest objectives that scale in difficulty, and narrative flavor text that occasionally tries to be profound but mostly lands in the realm of heroic melodrama. It also provides a structured backbone for games that can otherwise drift into improvisational chaos. That’s not a bad thing here; it’s a feature that helps you orchestrate a longer arc without letting the whole thing disintegrate into you versus the next five zombie spawns forever.
...
The Quest Book comes with a fresh batch of components that fit neatly into the Black Plague ecosystem. You’ll find quest cards organized into the campaign deck, new hero boards, and a handful of tokens that mark progress, wounds, and occasional plot twists. The production quality remains high, as you’d expect from a Zombicide product: sturdy cards, robust boards, and artwork that leans into the grimy, high-fantasy vibe that the franchise does so well.

Setup takes longer than a standard game night, but in practice, it’s a rhythm that grows on you. Here’s a suggested flow:

- Unwrap the Quest Book and bump the sleeves for the campaign deck. It’s a moment of quiet, a tiny ceremony where you acknowledge that you are about to invest in a longer form of chaos.
- Separate the quest cards by act — Act I introduces the situation, Act II escalates, Act III hits you with a choice that might break your heart or your save file — whichever comes first.
- Prepare your party by selecting heroes. The Quest Book often recommends certain archetypes for specific quests, which makes party composition a little more strategic than the usual free-for-all chaos.
- Lay out the campaign board and the new encounter tiles. These are not fancy magnets; they’re sturdy, functional, and designed to survive multiple playthroughs. You will spill coffee on them, you will spill snacks on them, and you will probably spill something else by the end of the night.
...
Each quest has specific objectives, and some quests require your team to complete secondary tasks to unlock the next chapter. Think of it as a board game equivalent of a TV arc — you’re chasing a larger climax rather than ticking off a handful of separate wins. The quest cards introduce a mix of cooperative and semi-cooperative stakes. There are moments where you must assist a fellow survivor or risk the whole team failing due to a misread of the objective. This is smart design because it nudges players toward interaction, rather than pure, headlong zombie revenge fantasies.

The design also curtails the chaos a little. In the base game, you can sometimes blitz through a round using brute force. The Quest Book nudges you into pacing — you’ll need to manage morale, supplies, and the threats that drift into the board in a way that mirrors a narrative arc. It’s not a heavy-handed rule tweak; it’s a gentle shepherd guiding your tabletop into a story-forward experience. If you enjoy planning your moves several turns ahead and imagining how your group’s story will unfold, you’ll find the pacing surprisingly satisfying.
...
- Quest objectives with cascading effects: finishing one objective may unlock a new set of conditions for the next quest. You’ll want to track progress carefully, or you’ll wake up to a board that looks like a winter storm of tokens.
- Mode-specific rules: some quests introduce temporary rules that change how certain monsters move or how your heroes can interact with the environment. These shifts are optional in the sense that you can opt out if your group wants a lighter experience, but they’re part of what makes the campaign feel distinct.
- Resource management: the campaign often emphasizes supply tracking. You’ll have to decide when to squad up and press forward or hunker down to gather resources. The choices aren’t always obvious, which means you’ll argue in the best possible way about the right course of action.
...
The tension doesn’t just come from the undead. It comes from the pacing and the storytelling choices you make. Do you press forward into a dangerous zone to achieve a crucial objective now or do you retreat and secure more supplies, hoping to weather a future storm? The Quest Book doesn’t punish you for risk-taking; it rewards thoughtful risk and punishes reckless bravado in a way that feels fair and cinematic rather than punitive.
...
- Track resources with care: morale, supplies, and special tokens matter more in campaign mode. A simple organizer or a dedicated dry-erase sheet helps prevent post-game mental fatigue the next day.
...
If you’re a casual player who enjoys a few spontaneous Zombicide sessions, you can still have fun with the Quest Book, but you might want to pace yourself and not treat it as a mandatory upgrade for every game night. The core experience remains wonderful in its own right, and the Quest Book is optional in the sense that you can dip your toes into the campaign and then return to shorter sessions without losing any of the core charm.
