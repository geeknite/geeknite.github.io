...
![Exploding Kittens artwork]({{ '/assets/images/exploding-kittens-asmodee-2018.jpg' | relative_url }})

If you want a closer look at the art and a sense of how the kittens are depicted, check the official site for the franchise and the 2018 edition gallery: [Exploding Kittens Official](https://www.explodingkittens.com/). The card art is intentionally whimsical, cartoonish, and a little absurd—exactly the energy you want when you’re about to lose a round to a mischievous feline with a defuse device strapped to its tail.
