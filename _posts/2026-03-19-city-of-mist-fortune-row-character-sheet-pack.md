...
Fortune Row leans into the art-deco noir aesthetic you expect from City of Mist. The sheets use a restrained color scheme with pops of gold and teal, which is not only pretty to look at but also functional: different sections have subtle color cues that help players find their sheets in a dimly lit gaming room at 11 PM when the daiquiris are starting to catch up with everyone’s dice. The branding elements are tasteful—no gaudy watermarks or screaming fonts. The result is something you want to leave on the table rather than stash in a binder in a closet of shame.

### The practical ergonomics
From a usability standpoint, the sheets are laid out in a way that makes sense for the game’s tempo. There’s a clear split between identity, mythic abilities, and relationships. The latent tension between “Power level” and “Mask identity” is given a neat, readable treatment that helps players decide what to emphasize in the moment. A well-placed “Aspect of Fortune Row” rubric gives you a quick mechanical way to push a scene toward the mood you want: a hint, a threat, a signpost, or a full-blown moment of dramatic irony. If you’ve played City of Mist before, the sheets feel like an extension of your character’s ongoing story rather than a bureaucratic obstacle.

### Accessibility and readability
The font choices and spacing work for long gaming sessions, with high contrast for legibility and generous margins for actual writing space. This is not a glossy one-page cheat sheet; it’s a proper character sheet kit that’s meant to be used, annotated, and tossed around the table with chips and coffee rings. This matters because some people like their character sheets to be “pretty” but non-functional. Fortune Row avoids that trap by prioritizing readability over visual flair alone. If you’re someone who loves a design-forward product that still behaves like a tool you can rely on, Fortune Row lands well on this axis.
...
City of Mist is as much about relationships as it is about powers. Fortune Row recognizes this by providing relationship grids that feel integrated with the character sheet. It’s a subtle but essential feature: you can track alliances and rivalries on the same page where you record your powers, which helps to remind players that the city’s soul is as important as any single move they make. The result is a sheet that encourages ongoing character development rather than a nightly sprint toward “the next big fight.”

## Playability: scenarios and table dynamics

### Quick-start usability
If you’re a GM who wants players into the action quickly, Fortune Row helps you do that without forcing you to memorize a new vocabulary or a new grid. You can hand a sheet to a first-time player, and they’ll have a readable map of their identity and abilities. The sheets are not just tactile but functional; you can see at a glance how far a character is from maxing out a mythic power, or how many downtime opportunities they have left in a given arc. This is particularly handy if you’re running a session with a mix of veterans and new players, because the pack reduces the cognitive load for newcomers and preserves the feel you want for the regulars.

### A session flow friendly design
Fortune Row’s layouts promote a natural flow: identify and reveal, empower, conflict, resolve, and reflect. The structure of the sheets aligns with a typical City of Mist session arc, which often cycles through the unveiling of a mystery, the escalation of a conflict, and the moment when the city’s mask starts to crack. The pack’s design helps you track that arc without a dozen separate sheets or post-it notes scattered across the table. If you’re a GM who loves “notes in the margins” on a single page, you’ll appreciate how Fortune Row consolidates essential data into a manageable form.

## Value, pricing, and how it stacks up against the competition

### Pricing expectations vs. utility
Value is always subjective in RPG accessories, but there are some objective signals you can use. Fortune Row offers a fairly comprehensive set of sheet variants, plus GM aids and notes pages. If you’re playing weekly sessions with a stable group, the pack can pay for itself in reduced table friction and faster session setup. If you’re a dungeon-delver who hates to annotate, and you prefer a minimalist approach, you might consider whether you actually need all the variants. In that case, you could still buy the core sheets and supplement them with your own printable sheets. The price point is fair for what you get, provided you’re in the market for a dedicated character sheet system designed to align with the Fortune Row aesthetic and gameplay tempo.

### How it compares to other sheets
...
Short answer: yes, if you’re invested in a tight, thematically coherent City of Mist experience and you want to minimize the time you spend chasing down paper trails instead of playing the game. Fortune Row delivers a character sheet pack that aligns with the Fortune Row aesthetic and the game’s mythic mechanics, while also offering practical tools for faster session setup and clearer tracking of relationships and powers. It’s not a magic bullet; you’ll still need a good GM, a strong table, and players who are excited about masks, myths, and a city that feels alive enough to gamble with their fates. But as a semi-durable, semi-beautiful set of sheets that makes the game feel more intentional, Fortune Row is a strong candidate for your next purchase.

If you’re running a Fortune Row campaign or you’ve got a group that enjoys the noir-meets-mythic vibe, this product helps you keep the energy high and the pacing steady. It’s a better-than-average accessory that respects the core mechanics of City of Mist while offering practical improvements to the table experience.

## Where to buy and how to support Geeknite

You can find the Fortune Row Character Sheet Pack on the official City of Mist site and through partner retailers. For readers who want to support Geeknite through their purchases, we’ve included an affiliate option below. Using our affiliate links won’t cost you extra, but it helps us keep the lights on and the pens flowing for more nerdy content like this. If you like what you see here, consider checking out the pack through one of these sources:
...
- It’s worth it for groups who want a cohesive aesthetic across sessions and who appreciate clear tracking of masks and mythic costs.
- If you’re a GM who loves DIY customization and already has a favorite set of house rules, Fortune Row can be a great base pack that you tailor to your system—without losing the flavor of Fortune Row.
...
In short: Fortune Row is a well-crafted addition to City of Mist that respects the game’s core mechanics while delivering a strong thematic package. It’s not the cheapest option on the shelf, but you get a good blend of style, function, and narrative potential that makes your table feel like a living, breathing city of masks.
