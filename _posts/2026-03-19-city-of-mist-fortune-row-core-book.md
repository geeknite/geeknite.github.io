---
title: Fortune Row: City of Mist Core Book Review
date: 2026-03-19
tags:
  - City of Mist
  - Fortune Row
...
Fortune Row gives you a district sheet—think of it as a living, breathing map of temptations and secrets. The book also arms you with a new baseline of mechanics that are particularly well-suited to running a campaign that centers on intrigue and vibe rather than pure dungeon-bashing. It is a setting that rewards longform investigations, social gambits, and a little bit of theatricality, which is par for the course for City of Mist but a welcome shift if your table enjoys more talk, less crunch, and a lot of neon rain.
...
- The Velvet Executor: a charming manipulator who can bend social rules while projecting absolute competence. In Fortune Row, this mask excels at negotiating with the city’s various factions, turning every encounter into a high-stakes negotiation with potential for dramatic reversals.
- The Neon Oracle: a diviner of probabilities who sees patterns in the city’s random noise. This Mask gives you strong hooks for clue gathering and predictive misdirection—perfect for campaigns built around a mystery that only resolves when players decipher the city’s tempo.
- The Coin Shepherd: a fixer who handles both goods and information with a gambler’s mercy. They are the go-to for illicit gear and convenient alliances, and their presence makes Fortune Row feel like a living market where deals are etched into the rain-slick pavement.

Beyond Masks, Fortune Row introduces new Anchors and Factions that feel like they were born from late-night bar stools and subway tunnel acoustics. Anchors are those personal touchstones that keep a character’s arc anchored in emotion, while Factions provide the friction that makes the district feel alive rather than a static backdrop. The factions move at a believable pace, with agendas that evolve across sessions, not just within a single dramatic beat. That evolution matters because it gives your players a reason to care about the long arc, not just the one-night score.
...
- Clue Chains: The book refines how clues chain together, encouraging players to follow a thread across multiple scenes, each with its own thematic color. The design makes sense for a district that has interlocked businesses, each with its own risk-reward calculus.
- District-Driven Scenes: You’ll get scene prompts that are specifically anchored to Fortune Row’s locales. Rather than your GM inventing a new lead every session, you can point to a district area and say, This is a potential crucible for this arc. It’s a small but meaningful shift toward a more location-centric campaign rhythm.
- Mask-Tied Power Surges: Some new Masks unlock unique once-per-session mechanics that let a character crash a scene with style. The payoff is not just the dice; it’s the story: players feel the weight of a single dramatic moment when it’s anchored to a mythic identity.
- Stress and Fate Pathways: The book continues City of Mist tradition of “bad decisions leading to interesting outcomes.” The Fate pathways get refined for Fortune Row, presenting more nuanced consequences for players who push too far into the district’s hazards. The moral texture of the game thickens in a good way here.
...
- Vibe First, Rules Second: Fortune Row emphasizes atmosphere as a vehicle for action. You’ll get advice on describing rain-slick streets, the clack of heels on marble floors, and the metallic taste of a high-stake bet. The mechanics slot in where mood demands it, not the other way around.
- Flexible Timeline: The district’s energy is not bound to a single timeline. You can jump between micro-sessions that explore different corners of Fortune Row or stitch them into a talon-like arc with a clear crescendo. It’s a practical approach for groups with irregular play windows.
- Faction Negotiation: The factions aren’t inert. They negotiate with the players, sometimes offering bargains, other times making life harder. This makes the world feel reactive, which is essential for a game about mythic identity clashing with real-world consequences.
- Clue Allocation: The book provides a method to distribute clues in a way that rewards curiosity and caution. It’s a balancing act; you want players to chase leads without feeling overwhelmed by a wall of red herrings. Fortune Row gives you a clean path through that maze.
...
Weaving in the Masks, the Anchors, and the District’s micro-dramas creates a rhythm: a scene of social maneuvering, a brief tug-of-war with fate, and a final reveal where the city’s mythic order threatens to tilt. Fortune Row makes room for humor without undermining the gravity of the setting. The humor often comes from character voice and the interplay between Masks; it’s the kind of tone that makes a table lean in and lean back, smiling while quietly planning the next move.
...
- Pros:
  - Strong mood and setting that invites social play and detective-style investigations
  - Robust Masks and Anchors to deepen character arcs and group dynamics
  - Scalable pacing with flexible session structure for irregular play schedules
  - Thoughtful district-specific prompts that keep players engaged and curious
- Cons:
  - The sheer density of options can be a little intimidating for first-time City of Mist GMs
  - If your table dislikes heavy lore and locale-driven play, Fortune Row might feel a bit niche
...
- {% post_url 2025-05-03-city-of-mist-core-book-review %}
- {% post_url 2025-09-17-city-of-mist-mechanics-deep-dive %}
- {% post_url 2024-11-20-city-of-mist-campaign-starter-guide %}
- {% post_url 2026-01-08-city-of-mist-character-creation-tips %}
...
If you want a sure-fire way to add flavor, tension, and memorable scenes to your next City of Mist run, Fortune Row is a strong choice. It respects the game’s core strengths while delivering a fresh, district-centric spin that can breathe new life into a tired campaign, or anchor a new one with style.

**Affiliate note: if you’re picking up Fortune Row to run with your crew, consider using our preferred affiliate link to support Geeknite while you level up your table.**

**Grab Fortune Row today through our affiliate link: https://example.com/aff/city-of-mist-fortune-row?ref=geeknite**