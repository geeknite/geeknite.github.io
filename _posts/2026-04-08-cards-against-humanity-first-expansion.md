...
## Quick Notes and Practical Advice
- Start with a curated subset of the toughest prompts; you don’t need to flood the table with every new card in one night.
- Rotate players as judges. A rotating judge keeps the energy from stagnating and prevents any single player from hogging the laughs.
...
**Grab your copy here via our affiliate link: https://cardsagainsthumanity.com/affiliate/cah-first-expansion**