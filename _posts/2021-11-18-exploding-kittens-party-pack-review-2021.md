---
title: "Exploding Kittens Party Pack Review: Bigger Parties, Fewer Quiet Moments"
date: 2021-11-18
tags:
  [
    board-games,
...
If you want the quick elevator pitch: kitty chaos, strategic mischief, and a surprising amount of strategy behind those cute paw prints. If you want a hyperlink to the official source, check out the product page: [Exploding Kittens Party Pack on ExplodingKittens.com](https://www.explodingkittens.com/products/party-pack).

For fans of the meta, see our earlier look at the base game [in our Exploding Kittens core review]({{ site.constants.wsib }}exploding kittens core review). If you’re hunting for party game heuristics, our round-up on party staples might help [post_url 2021-05-03-best-party-games-roundup].
...
If you’re curious about exact contents in your local box, the official listing is a reliable reference. And while we’re at it, you can explore another of the party-starter classics here: [A deeper dive into group dynamics in card games]({{ site.constants.wsib }}group dynamics card games).
...
For those who want to dive deeper into social strategy, our article on “Reading the Room in Party Card Games” is a perfect companion piece: [Reading the room in party games]({{ site.constants.wsib }}reading the room party games).
...
If you want to compare the visual style to other sketched humor titles, see our breakdown of card-art trends in modern party games here: [Card art trends in party games]({{ site.constants.wsib }}card art trends).
...
If you’re curious about table setup for big groups, this quick guide on space-efficient play might help: [Space-saving table layouts for party games]({{ site.constants.wsib }}space saving party games).
...
If you want an academically-inclined take on large-group dynamics in card games, our panel-style piece might be up your alley: [Group dynamics in large party card games]({{ site.constants.wsib }}group dynamics panel).
...
For readers who like to consider “value” in multiple dimensions, we also anchor this against other party staples in the same tier. See our comparison post: [Party game value comparisons for 2021]({{ site.constants.wsib }}party game value comparisons).
...
**Buy Exploding Kittens Party Pack now through our affiliate link: https://affiliates.example.com/exploding-kittens-party-pack**
