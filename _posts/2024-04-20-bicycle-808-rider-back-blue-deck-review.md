---
title: "Bicycle Poker 808 Rider Back Playing Cards Blue Deck & Dice - Review"
date: 2024-04-20
tags:
  - cards
  - gaming
...
### Handling, shuffles, and tea ceremonies (not recommended)
...
- Deck Maintenance 101 — a practical guide to keeping your decks in prime shape. [Read more here]({% post_url 2023-08-15-deck-maintenance %})

- Top Blue Rider Back Decks — a quick round-up of the best blue Rider Back decks we've tested. [See the list]({% post_url 2024-01-10-top-blue-rider-decks %})
...
For further reading on the broader context of playing cards, take a look at the encyclopedia entry on playing cards: [Playing cards on Wikipedia](https://en.wikipedia.org/wiki/Playing_card). This is optional but fun when you’re curious about card history and design lineage.

And for more brand-specific info: [Bicycle Official Site](https://www.bicyclecards.com) — because if you’re going to collect and compare, you want to go right to the source and see the catalog, the print runs, and the official photography for each flavor of Rider Back we obsess over.
...
**Buy now via our affiliate link: https://affiliate.example.com/bicycle-808**